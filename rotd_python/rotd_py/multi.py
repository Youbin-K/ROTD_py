...
class multi_master():
    ...
    work_queue : WorkQueue in master_slave
...
class MySlave(Slave):
    ...
    def do_work(self, data):
        ...
        # here data is the input value x, should be a float number in (0,1)
        # which is the length of the matrix
...
class Multi(object):
    """
    This is the application Multi that has a lot of work to do. (Main function in the example code)
    It gives work to slaves until all the works are done.
    """
